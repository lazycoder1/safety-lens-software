...
Rakshak Lens is an on-premise, AI-powered video analytics platform for industrial safety and security. It processes live camera feeds to detect safety violations, recognize vehicles and faces, and trigger automated responses — all running on a single edge device with no cloud dependency.
...
│  │ 1080p, 5FPS  │  │ by camera    │  │ YOLOE-26S (pilot)  │  │
...
The rules engine is the core of Rakshak Lens automation. Every alert, gate action, and notification flows through it.
...
|-------------|--------|---------------------------|
| General surveillance | YOLO26n + YOLOE-26S | ~5ms |
| Gate (ANPR + face) | YOLO26n + YOLOE-26S + YOLO26s + PaddleOCR + SCRFD + ArcFace | ~18ms |
| Work zone (PPE focus) | YOLO26n + YOLOE-26S | ~5ms |
...
- Verified with public key baked into Rakshak Lens Docker image
