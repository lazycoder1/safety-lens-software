# Rakshak Lens — UI/UX Style Guide
...
Rakshak Lens is a **control room tool**. It will run on a big screen in a factory safety office, 24/7. Every design decision flows from this:
...
┌─────────────────────────────────────────────────────────────────┐
│  Top Bar (48px)                                                  │
│  ┌──────┐  Rakshak Lens    [Live] [Alerts] [Dashboard] [Config]   │
│  │ Logo │                                    ┌────────────────┐ │
│  └──────┘                                    │ 3 Active Alerts│ │
│                                              └────────────────┘ │
├──────────────────────────────────────────────────────────────────┤
...
Rakshak Lens is primarily a **desktop/large-screen** application. But it should degrade gracefully.
