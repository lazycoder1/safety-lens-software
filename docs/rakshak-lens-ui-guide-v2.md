# Rakshak Lens — UI Guide

**Version:** 2.0
**Date:** 2026-03-28

This document covers new and updated pages. The existing style guide (colors, typography, spacing, components) remains unchanged — refer to `rakshak-lens-ui-styleguide.md` for design tokens.
